...
$(document).ready(function() {
  ...
  $(function() {
    $('#startDateField').datetimepicker({
      ...
      beforeShow: function(dateText, inst) {
        ...
        if ($("#endDateField").val() != '') {
          $(this).datetimepicker("option", "maxDate", new Date(Date.parse($("#endDateField").datetimepicker(
            'getDate').getTime())));
        }
      },
    ...
    $('#endDateField').datetimepicker({
      ...
      beforeShow: function(dateText, inst) {
        ...
        if ($("#startDateField").val() != '') {
          $(this).datetimepicker("option", "minDate", new Date(Date.parse($("#startDateField").datetimepicker(
            'getDate').getTime())));
        }
      },
      onClose: function(dateText, inst) {
  ...
  function nextClick(event) {
    ...
    window.location = healthUrl + 'health_maintainance?zone=' + $('#selectedZone').val() + "&currentpage=" +
      currentPage;
  }
...
function editSchedMaintenanceGet(current) {
  ...
  $.ajax({
    ...
    success: function(html) {
      ...
      $thisPanel.dialog('option', 'buttons', {}).dialog("open");
    },
    error: function() {
      $(".addNewStatus").unbind('click');
    }
