              ...
              <li>
                ...
                <c:choose>
                  ...
                  <c:otherwise>
                    ...
                    <div class="main_addnew_formbox_errormsg_popup" id="configproperty<c:out value='${instance_property.serviceConfigMetadata.id}'/>Error" style="margin:0 0 0 155px;"></div>
                  </c:otherwise>
                </c:choose>
              </li>
              </c:if>
