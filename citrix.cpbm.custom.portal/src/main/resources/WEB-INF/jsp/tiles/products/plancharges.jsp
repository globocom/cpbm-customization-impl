...
<div class="dialog_formcontent wizard" style="height:auto">
  <div class="details_lightboxtitlebox" >
    ...
    <spring:url value="/portal/products/plancharges" var="plan_charges_path" htmlEscape="false" /> 
    <form:form commandName="productForm" id="productForm" cssClass="formPanel ajaxForm"  action="${plan_charges_path}"  >    
    <ul> 
