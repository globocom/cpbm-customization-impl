...
<script type="text/javascript" src="<%=request.getContextPath() %>/js/rpc.js"></script>
...
<spring:url value="/portal/rpc/update_disk_offerings" var="rpc_update_path" htmlEscape="false"/>
...
<div class="mainbox " style="display: block;">
	<div class="main_titlebox">
		<h2>Disk Offerings</h2>
	</div>
<div class="grid_container">
<div class="clearboth"></div>
<div style="float:right;margin:5px;font-size: 14px;">
<label for="domainId">Filter By Domain</label>
<select name="domainId" class="filterbydiskdomain" >
<c:forEach items="${domainList}" var="choice" varStatus="status">
   <option value="<c:out value="${choice.id}" />"
   <c:if test="${domainId == choice.id}">selected='selected'</c:if>
