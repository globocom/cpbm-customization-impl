...
var CODE_NOT_UNIQUE_ERROR_CODE=601;var AJAX_FORM_VALIDATION_FAILED_CODE=420;var INVALID_AJAX_REQUEST_ERROR_CODE=420;var PAGINATION_PAGE_SIZE=13;var PAGINATION_CURRENT_PAGE_NUMBER=1;var INTERNAL_SERVER_FAILED_CODE=500;var PRECONDITION_FAILED=412;var ssoResponseMap=null;$(document).ready(function(){if($("#from_cas_login_page").val()=='true'){$.ajax({type:"GET",url:"/portal/portal/getSupportedLanguages",async:false,dataType:"json",success:function(response){var htmlToPush='';for(var key in response){htmlToPush=htmlToPush
...
var keycode_Enter=13;var $currentGridRow;function clickAnotherGridRow($thisGridRow){if($currentGridRow!=null&&$currentGridRow!=$thisGridRow)
...
var ERROR_ACCESS_DENIED_DUE_TO_UNAUTHORIZED=401;var ERROR_INTERNET_NAME_NOT_RESOLVED=12007;var ERROR_INTERNET_CANNOT_CONNECT=12029;var ERROR_VMOPS_ACCOUNT_ERROR=531;function handleError(XMLHttpResponse,handleErrorCallback){if(XMLHttpResponse.status==ERROR_ACCESS_DENIED_DUE_TO_UNAUTHORIZED){alert("Your session has expired.");}else if(XMLHttpResponse.status==ERROR_INTERNET_NAME_NOT_RESOLVED){alert("Your internet name cannot be resolved.");}else if(XMLHttpResponse.status==ERROR_INTERNET_CANNOT_CONNECT){alert("The Management Server is unaccessible.  Please try again later.");}else if(XMLHttpResponse.status==ERROR_VMOPS_ACCOUNT_ERROR&&handleErrorCallback!=undefined){handleErrorCallback();}else if(handleErrorCallback!=undefined){handleErrorCallback();}else{var errorMsg=localizeCloudStackMsg(fromdb(parseXMLHttpResponse(XMLHttpResponse)));if(errorMsg!=""){alert(errorMsg);}}}
...
+l3menuTenantParam;});$("#l3_account_0_tab").bind("click",function(event){$(".thirdlevel_subtab").removeClass("on").addClass("off");$(this).removeClass("off").addClass("on");window.location="/portal/portal/tenants/list?accountType="
...
+selectedAccountType+"&filterBy=4";});$("#l3_profile_serviceprovider_tab").bind("click",function(event){initialiseProfilesPage("spProfiles");});$("#l3_profile_customer_tab").bind("click",function(event){initialiseProfilesPage("customerProfiles");});$("#l3_profile_partner_tab").bind("click",function(event){initialiseProfilesPage("");});$("#12_content_0_tab").bind("click",function(event){$(".thirdlevel_subtab").removeClass("on").addClass("off");$(this).removeClass("off").addClass("on");window.location="/portal/portal/admin/email_templates?filterby=0";});$("#12_content_1_tab").bind("click",function(event){$(".thirdlevel_subtab").removeClass("on").addClass("off");$(this).removeClass("off").addClass("on");window.location="/portal/portal/admin/email_templates?filterby=1";});$("#12_content_2_tab").bind("click",function(event){$(".thirdlevel_subtab").removeClass("on").addClass("off");$(this).removeClass("off").addClass("on");window.location="/portal/portal/admin/email_templates?filterby=2";});$("#12_content_3_tab").bind("click",function(event){$(".thirdlevel_subtab").removeClass("on").addClass("off");$(this).removeClass("off").addClass("on");window.location="/portal/portal/admin/email_templates?filterby=3";});$("#12_content_4_tab").bind("click",function(event){$(".thirdlevel_subtab").removeClass("on").addClass("off");$(this).removeClass("off").addClass("on");window.location="/portal/portal/admin/email_templates?filterby=4";});$("#l3_billing_record_deposit_tab").bind("click",function(event){$(".thirdlevel_subtab").removeClass("on").addClass("off");$(this).removeClass("off").addClass("on");window.location="/portal/portal/billing/show_record_deposit?tenant="
+l3menuTenantParam;});$("#l3_config_configaccountmanagement_tab").bind("click",function(event){$(".thirdlevel_subtab").removeClass("on").addClass("off");$(this).removeClass("off").addClass("on");window.location="/portal/portal/admin/config/show_configuration?module=ConfigAccountManagement";});$("#l3_config_accountprovisioning_tab").bind("click",function(event){$(".thirdlevel_subtab").removeClass("on").addClass("off");$(this).removeClass("off").addClass("on");window.location="/portal/portal/admin/config/show_configuration?module=AccountProvisioning";});$("#l3_config_billing_tab").bind("click",function(event){$(".thirdlevel_subtab").removeClass("on").addClass("off");$(this).removeClass("off").addClass("on");window.location="/portal/portal/admin/config/show_configuration?module=Billing";});$("#l3_config_crm_tab").bind("click",function(event){$(".thirdlevel_subtab").removeClass("on").addClass("off");$(this).removeClass("off").addClass("on");window.location="/portal/portal/admin/config/show_configuration?module=CRM";});$("#l3_config_helpdesk_tab").bind("click",function(event){$(".thirdlevel_subtab").removeClass("on").addClass("off");$(this).removeClass("off").addClass("on");window.location="/portal/portal/admin/config/show_configuration?module=HelpDesk";});$("#l3_config_integration_tab").bind("click",function(event){$(".thirdlevel_subtab").removeClass("on").addClass("off");$(this).removeClass("off").addClass("on");window.location="/portal/portal/admin/config/show_configuration?module=Integration";});$("#l3_home_connectors_cs_tab").bind("click",function(event){$(".thirdlevel_subtab").removeClass("on").addClass("off");$(this).removeClass("off").addClass("on");window.location="/portal/portal/connector/cs";});$("#l3_home_connectors_oss_tab").bind("click",function(event){$(".thirdlevel_subtab").removeClass("on").addClass("off");$(this).removeClass("off").addClass("on");window.location="/portal/portal/connector/oss";});$("#l3_config_server_tab").bind("click",function(event){$(".thirdlevel_subtab").removeClass("on").addClass("off");$(this).removeClass("off").addClass("on");window.location="/portal/portal/admin/config/show_configuration?module=Server";});$("#l3_config_portal_tab").bind("click",function(event){$(".thirdlevel_subtab").removeClass("on").addClass("off");$(this).removeClass("off").addClass("on");window.location="/portal/portal/admin/config/show_configuration?module=Portal";});$("#l3_config_reports_tab").bind("click",function(event){$(".thirdlevel_subtab").removeClass("on").addClass("off");$(this).removeClass("off").addClass("on");window.location="/portal/portal/admin/config/show_configuration?module=Reports";});$("#l3_config_marketing_tab").bind("click",function(event){$(".thirdlevel_subtab").removeClass("on").addClass("off");$(this).removeClass("off").addClass("on");window.location="/portal/portal/admin/config/show_configuration?module=Marketing";});$("#l3_config_trialmanagement_tab").bind("click",function(event){$(".thirdlevel_subtab").removeClass("on").addClass("off");$(this).removeClass("off").addClass("on");window.location="/portal/portal/admin/config/show_configuration?module=TrialManagement";});function isBrowserIE7(){if(navigator.appVersion.indexOf('MSIE 7.')==-1)
return false;return true;}
function viewUtilitRates(tenantParam,id,url,serviceInstanceUUID){var target_url="/portal/portal/subscription/utilityrates_table?tenant="+tenantParam+"&serviceInstanceUuid="+serviceInstanceUUID;if(url!=null){target_url=url;}
$("#full_page_spinning_wheel").show();initDialog(id,850);$.ajax({type:"GET",url:target_url+"&isDialog=true",dataType:"html",cache:false,success:function(html){var $thisDialog=$("#"+id);$thisDialog.dialog('option','minHeight',400);$thisDialog.dialog('option','minWidth',750);$thisDialog.dialog('option','buttons',{"OK":function(){$(this).dialog("close");}});dialogButtonsLocalizer($thisDialog,{'Cancel':g_dictionary.dialogOK});$("#full_page_spinning_wheel").hide();$thisDialog.html(html);$thisDialog.dialog("open");},error:function(){$("#full_page_spinning_wheel").hide();}});return false;}
...
var returnVal=true;var url="/portal/portal/manage_resource/get_sso_cmd_string";if(tenantParam!=null&&tenantParam!=""){url=addParametersToUrl(url,"tenant",tenantParam);}
...
ssoResponseMap=null;returnVal=responseMap.url;}else{ssoResponseMap=responseMap;}},error:function(XMLHttpResponse){alert(g_dictionary.error_single_sign_on);ssoResponseMap=null;returnVal=false;}});return returnVal;}
...
String.prototype.format=String.prototype.f=function(argList){var s=this,i=argList.length;while(i--){s=s.replace(new RegExp('\\{'+i+'\\}','gm'),argList[i]);}
return s;};function getFormattedDisplayAttribtutesDescription(message,attributes){var displayString="";if(attributes!=null){var argsList=[];for(var i=0;i<attributes.length;i++){da=attributes[i];argsList.push(da.value);}
displayString=message.f(argsList);}
return displayString;}
function getFormattedDisplayAttribtutesString(attributes){var displayString="";if(attributes!=null){for(var i=0;i<attributes.length;i++){da=attributes[i];displayString+=displayString==""?"":", ";displayString+="<b>"+da.name+"</b> : "+da.value;}}
return displayString;}
function getFormattedAttribtutesString(attributes){var displayString="";if(attributes!=null){for(var component in attributes){displayString+=displayString==""?"":", ";displayString+="<b>"+component+"</b> : "+attributes[component];}}
return displayString;}
var showResourcesIFrameWithServiceInstanceUUID=function(serviceInstanceUUID){$("#maincontent_container").hide();$("#main").css("width","100%");$("#header").css("margin","auto");$("#footer").css("width","100%");$("#mainmenu_panel").css({"margin":"auto"});$("#manage_resources_container").show();var $iframe_tab=$("#iframe_tab_"+serviceInstanceUUID);$iframe_tab.find(".js_loading").show();$.ajax({url:"/portal/portal/manage_resource/get_resource_views",dataType:"json",async:false,data:{serviceInstanceUUID:serviceInstanceUUID,tenant:effectiveTenantParam},cache:false,success:function(json){singleSignOn(effectiveTenantParam,serviceInstanceUUID);$iframe_tab.find(".js_loading").hide();$(".js_iframe_tabs").removeClass("on");$iframe_tab.addClass("on");$("#manage_resources_iframe").attr("src",json[0].url);},error:function(XMLHttpResponse){$iframe_tab.find(".js_loading").hide();handleError(XMLHttpResponse);}});}
var showResourcesIFrame=function(event){var serviceInstanceUUID=$(this).attr("id");showResourcesIFrameWithServiceInstanceUUID(serviceInstanceUUID);}
function arr_diff(a1,a2)
{var a=[],diff=[];for(var i=0;i<a1.length;i++)
a[a1[i]]=true;for(var i=0;i<a2.length;i++)
if(a[a2[i]])delete a[a2[i]];else a[a2[i]]=true;for(var k in a)
diff.push(k);return diff;}
$(".doc_help_link").unbind("click").bind("click",function(e){window.open(help_link_path,'_blank');});