...
$.viewCatalogDetails = function(jsonResponse){
        ...
        content = content+"</div></div></div>";
				...
				content = content+"<div class='maindetails_footerlinksbox'><p><a href='javascript:void(0);' onclick='editCatalogGet(this)' class='editCatalog' id='edit"+jsonResponse.id+"'>"+ i18n.label.catalog.Edit+"</a> <span > |</span> </p>"; 
				content = content+"<p><a href="+productBundlesUrl+"/"+jsonResponse.id+"/listbundles >"+ i18n.label.catalog.manage_bundle+"</a><span > |</span></p>";
				content = content+"<p><a href="+productBundlesUrl+"/"+jsonResponse.id+"/manageurc >"+ i18n.label.catalog.urc_title+"</a></p>";				
