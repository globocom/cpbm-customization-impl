...
function convertBytes(bytes) {
	if (bytes < 1024 * 1024) {
		return formatNumber((bytes / 1024).toFixed(2)) + " " + g_dictionary.KB;
	} else if (bytes < 1024 * 1024 * 1024) {
		return formatNumber((bytes / 1024 / 1024).toFixed(2)) + " " + g_dictionary.MB;
	} else if (bytes < 1024 * 1024 * 1024 * 1024) {
		return formatNumber((bytes / 1024 / 1024 / 1024).toFixed(2)) + " " + g_dictionary.GB;
	} else {
		return formatNumber((bytes / 1024 / 1024 / 1024 / 1024).toFixed(2)) + " " + g_dictionary.TB;
	}
}
...
var cloudStackLoginResponse, cloudStackSessionKey, userTimeZoneOffset, cloudStackSupportELB, cloudStackFirewallRuleUiEnabled;

var cloudStackVersion = "";

var isCloudStack22X = false;

var isCloudStackActonOrAbove = false;
...
$("#13_health_scheduled_maintainence_tab").bind("click", function(event) {
  var selectedServiceInstanceUUID = $("#selectedServiceInstance").find(".downarrow").attr("id");
	...
	$(this).removeClass("off").addClass("on");
  if(typeof selectedServiceInstanceUUID =='undefined' || selectedServiceInstanceUUID == null || selectedServiceInstanceUUID=="") {
    window.location = "/portal/portal/health/healthmaintainance";
  } else {
    window.location = "/portal/portal/health/healthmaintainance?serviceInstanceUUID="+selectedServiceInstanceUUID;
  }
});
...
$("#l3_service_bundles_tab_browse_catalog")
		.bind(
				"click",
				function(event) {
					var searchq = window.location.search;
					...
					if (searchq.indexOf("lang=") != -1) {
						lang = searchq.substring(searchq.indexOf("lang="));
						window.location = "/portal/portal/browse_catalogs?t="+$(".secondlevel_menutabs.on").attr("id")+"&showServiceBundles=true&"
								+ lang;
					} else
						window.location = "/portal/portal/browse_catalogs?t="+$(".secondlevel_menutabs.on").attr("id")+"&showServiceBundles=true";
				});
...
$("#12_content_0_tab").bind("click", function(event) {
	$(".thirdlevel_subtab").removeClass("on").addClass("off");
	$(this).removeClass("off").addClass("on");
	window.location = "/portal/portal/admin/emailtemplates?filterBy=0";
});

$("#12_content_1_tab").bind("click", function(event) {
	$(".thirdlevel_subtab").removeClass("on").addClass("off");
	$(this).removeClass("off").addClass("on");
	window.location = "/portal/portal/admin/emailtemplates?filterBy=1";
});

$("#12_content_2_tab").bind("click", function(event) {
	$(".thirdlevel_subtab").removeClass("on").addClass("off");
	$(this).removeClass("off").addClass("on");
	window.location = "/portal/portal/admin/emailtemplates?filterBy=2";
});

$("#12_content_3_tab").bind("click", function(event) {
	$(".thirdlevel_subtab").removeClass("on").addClass("off");
	$(this).removeClass("off").addClass("on");
	window.location = "/portal/portal/admin/emailtemplates?filterBy=3";
});
...
.bind(
    ...
    function(event) {
      $(".thirdlevel_subtab").removeClass("on").addClass("off");
      $(this).removeClass("off").addClass("on");
      window.location = "/portal/portal/admin/config/showconfiguration?module=ConfigAccountManagement";
    });
...
.bind(
    ...
    function(event) {
      $(".thirdlevel_subtab").removeClass("on").addClass("off");
      $(this).removeClass("off").addClass("on");
      window.location = "/portal/portal/admin/config/showconfiguration?module=AccountProvisioning";
    });
...
.bind(
    ...
    function(event) {
      $(".thirdlevel_subtab").removeClass("on").addClass("off");
      $(this).removeClass("off").addClass("on");
      window.location = "/portal/portal/admin/config/showconfiguration?module=Billing";
    });
...
.bind(
    ...
    function(event) {
      $(".thirdlevel_subtab").removeClass("on").addClass("off");
      $(this).removeClass("off").addClass("on");
      window.location = "/portal/portal/admin/config/showconfiguration?module=CRM";
    });
...
.bind(
    ...
    function(event) {
      $(".thirdlevel_subtab").removeClass("on").addClass("off");
      $(this).removeClass("off").addClass("on");
      window.location = "/portal/portal/admin/config/showconfiguration?module=HelpDesk";
    });
...
.bind(
    ...
    function(event) {
      $(".thirdlevel_subtab").removeClass("on").addClass("off");
      $(this).removeClass("off").addClass("on");
      window.location = "/portal/portal/admin/config/showconfiguration?module=Integration";
    });
...
.bind(
    ...
    function(event) {
      $(".thirdlevel_subtab").removeClass("on").addClass("off");
      $(this).removeClass("off").addClass("on");
      window.location = "/portal/portal/admin/config/showconfiguration?module=Server";
    });
...
.bind(
    ...
    function(event) {
      $(".thirdlevel_subtab").removeClass("on").addClass("off");
      $(this).removeClass("off").addClass("on");
      window.location = "/portal/portal/admin/config/showconfiguration?module=Portal";
    });
...
.bind(
    ...
    function(event) {
      $(".thirdlevel_subtab").removeClass("on").addClass("off");
      $(this).removeClass("off").addClass("on");
      window.location = "/portal/portal/admin/config/showconfiguration?module=Reports";
    });
...
.bind(
    ...
    function(event) {
      $(".thirdlevel_subtab").removeClass("on").addClass("off");
      $(this).removeClass("off").addClass("on");
      window.location = "/portal/portal/admin/config/showconfiguration?module=Marketing";
    });
...
.bind(
    ...
    function(event) {
      $(".thirdlevel_subtab").removeClass("on").addClass("off");
      $(this).removeClass("off").addClass("on");
      window.location = "/portal/portal/admin/config/showconfiguration?module=TrialManagement";
    });
...
function viewUtilitRates(tenantParam, id, url) {
	var target_url="/portal/portal/subscription/utilityrates_lightbox?tenant="+ tenantParam;
	if(url!=null){
		target_url=url;
	}
  $.ajax({
    ...
    success : function(html) {
      initDialog(id, 800);
      var $thisDialog = $("#" + id);
      $thisDialog.dialog('option', 'height', 700);
    ...
    $.ajax({
        ...
        success: function (responseMap) {
          if(responseMap.status == 'fail'){
            ...
            if(responseMap.callback != undefined){
            	//eval(responseMap.callback +"("+responseMap.cmdString+")");
            }
        }
       },
        error: function (XMLHttpResponse) {
        	alert('Error while getting SSO command string');
           //TODO: need to do appropriate error handling here
          }
    });
    return returnVal;
}
