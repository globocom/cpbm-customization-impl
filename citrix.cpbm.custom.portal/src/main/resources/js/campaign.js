   ...
   var actionurl = campaignsUrl+"editcampaign";    
     $.ajax( {
       ...
       success : function(html) {
         ...
         $thisPanel.dialog({ height: 470, width : 700 });
                 ...
                 if($thisPanel.find("#campaignPromotionsForm").valid()){
                   $.ajax( {
                     ...
                     success : function(jsonObj) {
                       ...
                       $("#viewcampaignDiv").find("#top_message_panel").find("#status_icon").removeClass("erroricon").addClass("successicon").show();
                     ...
                     error : function (html) {
                       ...
                       $("#viewcampaignDiv").find("#top_message_panel").find("#status_icon").removeClass("successicon").addClass("erroricon").show();
